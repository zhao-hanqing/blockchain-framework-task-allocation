...
void CEPuckRangeAndBearingWrapper::SetData(const boost::python::list un_data) {
    ...
    const UInt32 unData[argos::CCI_EPuckRangeAndBearingActuator::MAX_BYTES_SENT] =
         {boost::python::extract<UInt32>(boost::python::object(un_data[0])),
          boost::python::extract<UInt32>(boost::python::object(un_data[1])),
          boost::python::extract<UInt32>(boost::python::object(un_data[2])),
          boost::python::extract<UInt32>(boost::python::object(un_data[3]))};
